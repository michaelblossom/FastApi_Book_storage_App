...
class TodoRequest(BaseModel):
    ...
    description: str = Field(min_length=20, max_length=60)
            ...
            "examples": [
                {
                    ...
                    "description":"Milk,cake,sadin,gesha,detergent,Tea,bread,Butter,biscuit,corn-flakes,chocolate,sugar,soap,gloceries,water,oat",
                    "priority":4,
                    "duration": 3,
                    "completed": False
                }
